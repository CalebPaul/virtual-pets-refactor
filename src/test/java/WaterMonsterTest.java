...
public class WaterMonsterTest {
  ...
  public void sleep_recordsTimeLastSleptInDatabase() {
    ...
    Timestamp rightNow = new Timestamp(new Date().getTime());
    assertEquals(DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(rightNow), DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(savedWaterMonsterLastSlept));
  }
  ...
  public void feed_recordsTimeLastAteInDatabase() {
    ...
    Timestamp rightNow = new Timestamp(new Date().getTime());
    assertEquals(DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(rightNow), DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(savedWaterMonsterLastAte));
  }
  ...
  public void play_recordsTimeLastPlayedInDatabase() {
    ...
    Timestamp rightNow = new Timestamp(new Date().getTime());
    assertEquals(DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(rightNow), DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(savedWaterMonsterLastPlayed));
  }
