...
public class FireMonsterTest{
  ...
  public void sleep_recordsTimeLastSleptInDatabase() {
    ...
    Timestamp rightNow = new Timestamp(new Date().getTime());
    assertEquals(DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(rightNow), DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(savedFireMonsterLastSlept));
  }
  ...
  public void feed_recordsTimeLastAteInDatabase() {
    ...
    Timestamp rightNow = new Timestamp(new Date().getTime());
    assertEquals(DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(rightNow), DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(savedFireMonsterLastAte));
  }
  ...
  public void play_recordsTimeLastPlayedInDatabase() {
    ...
    Timestamp rightNow = new Timestamp(new Date().getTime());
    assertEquals(DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(rightNow), DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(savedFireMonsterLastPlayed));
  }
  ...
  public void kindling_recordsTimeLastKindlingInDatabase() {
    ...
    Timestamp rightNow = new Timestamp(new Date().getTime());
    assertEquals(DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(rightNow), DateFormat.getDateTimeInstance(DateFormat.SHORT, DateFormat.SHORT).format(savedFireMonsterLastKindling));
  }
